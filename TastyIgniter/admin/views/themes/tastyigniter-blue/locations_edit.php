...
<!--TypeService added-->
					<div class="form-group">
						...
						<label for="input-ServiceType" class="col-sm-3 control-label">TypeService</label>
						<div class="col-sm-5">
						Eat In<input type="checkbox" name="mm" value="3000" onclick="chose(this)" /> &nbsp;&nbsp;  
        				Pre School Lunch<input type="checkbox" onclick="chose(this)" name="mm" value="2900"/>&nbsp;&nbsp;     
        				catering<input type="checkbox" onclick="chose(this)" name="mm" value="90"/>

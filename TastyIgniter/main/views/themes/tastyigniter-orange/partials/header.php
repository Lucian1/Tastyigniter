		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
                ...
                $('select.form-control').select2();
									...
									// var a = document.getElementById("#account-label");
									// a.onclick = function(
									// {
									// 	alert("Hellwo");
									// }
...
<!-- add login label start -->
									<li>
									<div class="nav navbar-nav navbar-right" id="main-header-menu-collapse" style="color:white;height:60px;line-height:60px">
									<?php echo "<h3>"?>	Welcome,

	...
	<div class="row content">
		<div class="col-md-12">
			...
			<!-- echo lang('label_assign_staff'); -->
											<label for="input-assign-staff" class="control-label"><?php echo "Staff Name" ?></label>
											<div class="">
										...
										<div class="col-xs-12 col-sm-2 clo-lg-2">
							...
							<!-- START window value added -->
							
										<div class="col-xs-12 col-sm-5 col-lg-2">
											<label for="input-name" class="control-label"><?php echo "Window";?></label>
											<div class="">
											<select name="window" class="form-control">
											<?php
											$windowNum = 1;
											for($windowNum=1;$windowNum<20;$windowNum++)
											{
												echo "<option value=".$windowNum.">"."Window".$windowNum."</option>";
											}
											?>
											</select>
							...
							<!-- END		window value added -->
										<div class="col-xs-12 col-sm-5 col-lg-4">
											<label for="input-name" class="control-label"><?php echo lang('label_comment'); ?></label>
											<div class="">
												<textarea name="status_comment" id="" class="form-control" rows="3"><?php echo "window8 you PIN is 888";?></textarea>
											<!-- echo "<option value=".$windowNum.">"."Window".$windowNum."</option>"; -->
												<?php echo form_error('status_comment', '<span class="text-danger">', '</span>'); ?>
											</div>
										</div>
										...
										<div class="col-xs-12 col-sm-2 col-lg-2 wrap-none">

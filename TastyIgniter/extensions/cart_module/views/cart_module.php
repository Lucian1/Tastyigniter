                    ...
                    <div class="location-control text-center text-muted">
                        <div id="my-postcode" style="display:<?php echo (empty($alert_no_postcode)) ? 'block' : 'none'; ?>">
                            <div class="btn-group btn-group-md text-center order-type" data-toggle="buttons">
                                ...
                                <?php } ?>
<!-- add drive through eat in start -->
                                <?php if ($has_collection) { ?>
                                    <label class="btn <?php echo ($order_type === '3') ? 'btn-default btn-primary active' : 'btn-default'; ?>" data-btn="btn-primary">
                                        <input type="radio" name="order_type" value="3" <?php echo ($order_type === '3') ? 'checked="checked"' : ''; ?>>&nbsp;&nbsp;<strong><?php echo 'Drivethru' ?></strong>
                                        <span class="small center-block">
                                            <?php if ($collection_status === 'open') { ?>
                                                <?php echo sprintf(lang('text_in_minutes'), $collection_time); ?>
                                            <?php } else if ($collection_status === 'opening') { ?>
                                ...
                                <?php if ($has_collection) { ?>
                                    <label class="btn <?php echo ($order_type === '4') ? 'btn-default btn-primary active' : 'btn-default'; ?>" data-btn="btn-primary">
                                        <input type="radio" name="order_type" value="4" <?php echo ($order_type === '4') ? 'checked="checked"' : ''; ?>>&nbsp;&nbsp;<strong><?php echo 'Eat in'; ?></strong>
                                        <span class="small center-block">
                                            <?php if ($collection_status === 'open') { ?>
                                                <?php echo sprintf(lang('text_in_minutes'), $collection_time); ?>
                                            <?php } else if ($collection_status === 'opening') { ?>
